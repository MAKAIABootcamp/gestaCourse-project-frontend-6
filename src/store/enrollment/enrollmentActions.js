...
import { addEnrollment, deleteEnrollment, setEnrollments, setStudentsInfo, setError, updateEnrollment } from "./enrollmentSlice";
import { firestore } from "../../firebase/firebaseConfig";

const enrollmentCollection = collection(firestore, 'enrollment')
const usersCollection = collection(firestore, 'users')

export const getDataStudentsInfo = () => {
    return async (dispatch) => {
        try {
            ...
            dispatch(setStudentsInfo(tempArr))
        } catch (error) {
            dispatch(
