    ...
    return (
        ...
        <StyleNavBar>
            <StyleLogoText >
                ...
                <StyleUl>
                    { (user==null ? itemsNoLogin : user.rol === 'admin'? itemsAdmin : itemsEstudent).map((item,index)=>{
                    ...
                    <StyleLi>
                        {
                            user==null ? <div></div> :<button type='button' onClick={() => {
                                navigate("/ofertasInscripciones");
